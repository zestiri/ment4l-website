    ...
    <footer className="text-canvas">
      <div className="mx-auto grid max-w-site gap-10 px-6 py-16 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
        ...
        <div className="flex flex-col gap-0.5 text-sm text-white/70">
          ...
          <Link href={JEUGDHULP_HUB.href} className="py-1.5 hover:text-white">Jeugdhulp West-Brabant</Link>
          <Link href="/trajecten/ambulante-spoedhulp" className="py-1.5 hover:text-white">Ambulante spoedhulp</Link>
