...
import { CONTACT, SLOGAN, AANMELD_URL } from "@/lib/site";
  ...
  return (
    <footer className="text-canvas">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-site flex-col gap-2 px-6 py-5 text-xs text-white/45 sm:flex-row sm:items-center sm:justify-between">
